   <%@include file="TEMPcatalogos.jsp"%> 
        ...
        <script src="js/validaciones.js"></script>
            ...
            <div class="page-header col-md-12" style="text-align:center;">
                <h2 style="font-weight:bold;"class="titulo-plantilla">Promotion</h2>
            </div>
            <div style="margin-bottom:30px;" class="col-md-12">
             
                <div style="margin-left: 38.33333333%;" class="col-md-3 ">
                ...
                <div class="col-md-12" style="text-align:center; margin-bottom:20px;" id="toolbar">
